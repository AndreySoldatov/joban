...
def test_whoami():
    ...
    whoami_resp = client.get("/auth/whoami", cookies={"DxpAccessToken": login_resp.cookies.get("DxpAccessToken")})
...
def test_logout():
    ...
    logout_resp = client.get("/auth/logout", cookies={"DxpAccessToken": login_resp.cookies.get("DxpAccessToken")})
